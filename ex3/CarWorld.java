...
class CarWorld extends JPanel {
    ...
    public CarWorld() {
        ...
        redCar = toolkit.getImage(getClass().getResource("/ex3/image/redcar.gif"));
        mt.addImage(redCar, 0);
        blueCar = toolkit.getImage(getClass().getResource("/ex3/image/bluecar.gif"));
        mt.addImage(blueCar, 1);
        bridge = toolkit.getImage(getClass().getResource("/ex3/image/bridge1.gif"));
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawRect(0, 0, bridge.getWidth(null), bridge.getHeight(null));
    }
